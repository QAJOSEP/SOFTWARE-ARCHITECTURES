package com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.sync.service;

import com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.command.event.Event;
import com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.command.event.comment.CommentAddedEvent;
import com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.command.event.comment.CommentRemovedEvent;
import com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.command.event.comment.CommentUpdatedEvent;
import com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.command.event.post.PostAddedEvent;
import com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.command.event.post.PostRemovedEvent;
import com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.command.event.post.PostUpdatedEvent;
import com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.command.event.reaction.ReactionAddedEvent;
import com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.command.event.reaction.ReactionRemovedEvent;
import com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.command.repository.EventStore;
import com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.query.model.Comment;
import com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.query.model.Post;
import com.josepillado.arquitecturasmodernas.cqrs.eventsourcing.query.repository.PostRepository;
