package com.josepillado.arquitecturasmodernas.cqrs.advanced.sync.service;

import com.josepillado.arquitecturasmodernas.cqrs.advanced.command.model.CommentCommand;
import com.josepillado.arquitecturasmodernas.cqrs.advanced.command.model.PostCommand;
import com.josepillado.arquitecturasmodernas.cqrs.advanced.command.model.ReactionCommand;
import com.josepillado.arquitecturasmodernas.cqrs.advanced.command.repository.CommentCommandRepository;
import com.josepillado.arquitecturasmodernas.cqrs.advanced.command.repository.PostCommandRepository;
import com.josepillado.arquitecturasmodernas.cqrs.advanced.command.repository.ReactionCommandRepository;
import com.josepillado.arquitecturasmodernas.cqrs.advanced.query.model.Comment;
import com.josepillado.arquitecturasmodernas.cqrs.advanced.query.model.Post;
import com.josepillado.arquitecturasmodernas.cqrs.advanced.query.model.Reaction;
